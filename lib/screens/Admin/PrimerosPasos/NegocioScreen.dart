...
class PP_Negocio_Screen extends StatefulWidget {
  ...
  const PP_Negocio_Screen({super.key, required this.pp_model});
...
class _PP_Negocio_ScreenState extends State<PP_Negocio_Screen>
    ...
    Future.delayed(Duration(seconds: 1), () {
      if (mounted) {
        ...
        _showCupertinoDialog('Configuración de negocio',
            'Por favor registra el nombre de tu negocio para continuar. No exceder mas de 13 caracteres.');
      }
    });
  }
  ...
  Future<void> _guardarNegocio() async {
    ...
    widget.pp_model.setNombreNegocio(_nombreNegocioController.text);
    // Animar el loader
    ...
    Navigator.push(
      ...
      PageRouteBuilder(
        pageBuilder: (context, animation, secondaryAnimation) {
          return PP_Sucursal_Screen(pp_model: widget.pp_model);
        },
