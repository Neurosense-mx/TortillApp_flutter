...
class MiPerfilMostrador extends StatelessWidget {
  final MostradorModel mostrador;
  final void Function(int)? onTabSelected;

  MiPerfilMostrador({Key? key, required this.mostrador, this.onTabSelected}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    final String username = mostrador.nombre;
    final String email = mostrador.email;
